            ...
            <div class="d-flex justify-content-center flex-wrap gap-2 col-12 col-md-8">
                ...
                <form method="POST" id="formContainer" action="" onsubmit="saveRecorder()" class="mitgard col-12 p-3">
                    ...
                    <div class="row">
                        ...
                        <input type="text" name="name" id="name" class="col-6 col-xl-4" required
                    ...
                    <div class="row justify-content-center">
                        <input type="number" name="pipe_number" id="pipe_number" class="col-2" max="4" min="1" value="1"
                            onchange="holeInput()" aria-describedby="pipeHelp"><br />
                    </div class="row">
                    ...
                    <div id="holes-container" aria-label="Lyukak száma csövönként">
                        <input type="number" id="holes1" name="holes1" class="holecount-input col-2" min="1" max="9"
                            value="1">
                    </div>
                    ...
                    <div class="row">
                        <div class="col-1"></div>
                        <input type="text" name="description" id="description" class="col-10" placeholder="Leírás"
                            maxlength="500"><br />
                        <div class="col-1"></div>
                    </div>
                    ...
                    <!-- Mentés gomb -->
                    <input type="button" onclick="saveRecorder()" value="Furulya mentése" class="btn btn-primary"
                        aria-label="Furulya mentése">
                </form>
